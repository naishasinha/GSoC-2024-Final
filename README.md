...
(1) All of the comprehensive code contributions can be accessed within this pull request: [CC Quantifying PR #123](https://github.com/creativecommons/quantifying/pull/123). <br> <br>
